      ...
      <TestContainer>
        ...
        <AboutContainer className="main">
          <div className="about-text">
            ...
            <p>
              Established in 2015, Tshinwelo Innovative Business Solutions
              (TIBS) is a 100% black owned company focused on organisational
              high performance through its Advisory and Digital business
              transformation offerings. Our background and experiences in
              Business strategy advisory, Supply chain management, Business
              process management and Human capital management has positioned us
              to offer pragmatic, innovative, implementable and sustainable
              solutions that fuse together traditional business approaches and
              methodologies with digital enabling technologies to allow
              organisations to reach high levels of performance. TIBS currently
              has a team of professionals with 50 years of combined experience
              dedicated to making sure your business needs are met.
            </p>
